...
void serverEarlyRetrans(UdpSocket &sock, const int max, int message[], int windowSize, int error)
{
    //number of messages received, used for tracking which messages to drop
